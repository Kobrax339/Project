...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
   //echo "id: " . $row["ID_Login"]. " - Imie: " . $row["Imie"]. " - Nazwisko: " . $row["Nazwisko"]. " - Login: " . $row["Login"]. " - Haslo:  " . $row["Haslo"]. "<br>";
 //echo "Witaj! ". $_REQUEST['ksa']. "<br />"; 
 //echo "Twoje haslo ". $_REQUEST['ksb']. "<br /> ";
  }
}
?>
...
<td><a href="/SkyMMS/stronawww/danebezperm.php"><img src="mm.png" width="40%" height="40%" class="center" alt="Tutaj jest obrazek" ></a>
...
<a href="/SkyMMS/stronawww/Logowanie.php" class="button">Wyloguj</a> 
